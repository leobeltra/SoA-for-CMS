...
For expand the code, ad example `SoAUnitTests.cc`, run

```bash
/usr/bin/c++ -DALPAKA_BLOCK_SHARED_DYN_MEMBER_ALLOC_KIB=47 -DALPAKA_DEBUG=0 -I/workspace/include -I/opt/Catch2/single_include/catch2 -I/opt/eigen -I/opt/Catch2/single_include -isystem /opt/alpaka/include -std=gnu++20 -E /workspace/tests/SoAUnitTests.cc >> expanded.cc
clang-format -i expanded.cc
```
